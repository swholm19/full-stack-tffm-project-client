...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://full-stack-tffm-project-api.herokuapp.com/',
...
var userUi = __webpack_require__(18);
var userApi = __webpack_require__(19);

var onGetUser = function onGetUser() {
  userApi.getUser().then(userUi.getUserSuccess).catch(userUi.getUserError);
};

var onSetUser = function onSetUser(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  userApi.setUser(data).then(userUi.getUserSuccess).catch(userUi.getUserError);
};
...
var getFormFields = __webpack_require__(4);
var playerUi = __webpack_require__(8);
var playerApi = __webpack_require__(10);
var store = __webpack_require__(2);

var onSignInFillRoster = function onSignInFillRoster() {
  playerApi.showPlayers().then(playerUi.signInFillRosterSuccess);
};

var selectPlayerForRoster = function selectPlayerForRoster(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  store.rosterSpot = data.player.roster_spot;
  playerApi.indexPlayer(data.player.ID).then(checkOwner).then(checkRosterSpotOpening).then(playerUi.assignPlayerToRosterSuccess).then(function () {
    return onSignInFillRoster();
  }).catch(playerUi.assignPlayerToRosterError);
};

var checkRosterSpotOpening = function checkRosterSpotOpening(response) {
  if (response !== undefined) {
    store.yourPlayers.forEach(function (currentPlayer) {
      if (response.player.id !== currentPlayer.id) {
        if (currentPlayer.roster_spot === store.rosterSpot) {
          currentPlayer.roster_spot = '';
          var data = { player: currentPlayer };
...
var checkOwner = function checkOwner(response) {
...
var onShowAllPlayers = function onShowAllPlayers() {
  playerApi.showPlayers().then(playerUi.showAllPlayersSuccess).catch(playerUi.assignPlayerToRosterError);
};
...
var onCreatePlayer = function onCreatePlayer(event) {
  ...
  playerApi.createPlayer(data).then(playerUi.createPlayerSuccess).catch(playerUi.createPlayerError);
};
...
var onUpdatePlayer = function onUpdatePlayer(event) {
  ...
  playerApi.updatePlayer(data.player.ID, data).then(playerUi.updatePlayerSuccess).then(function () {
    return onSignInFillRoster();
...
var onDeletePlayer = function onDeletePlayer(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  playerApi.deletePlayer(data.player.ID).then(playerUi.deletePlayerSuccess).then(function () {
    return onSignInFillRoster();
  }).catch(playerUi.deletePlayerError);
};

module.exports = {
  selectPlayerForRoster: selectPlayerForRoster,
  onSignInFillRoster: onSignInFillRoster,
  onShowAllPlayers: onShowAllPlayers,
...
var store = __webpack_require__(2);
var showPlayersTemplate = __webpack_require__(20);
var playerApi = __webpack_require__(10);

var signInFillRosterSuccess = function signInFillRosterSuccess(response) {
  $('.roster').html('-');
...
var assignPlayerToRosterSuccess = function assignPlayerToRosterSuccess(response) {
  if (response !== undefined) {
...
var assignPlayerToRosterError = function assignPlayerToRosterError() {
  $('#playerSelectModalLabel').html('Player Not Valid: ');
  $('#playerSelectModalLabel').css('color', 'red');
  $('#playerSelect-form')[0].reset();
};

var showAllPlayersSuccess = function showAllPlayersSuccess(response) {
  $('.all-players').empty();
  store.yourPlayers = response.players.filter(function (player) {
    return store.user.id === player.user_id;
  });
  var showPlayersHtml = showPlayersTemplate({ players: store.yourPlayers });
...
var createPlayerError = function createPlayerError(error) {
...
var updatePlayerError = function updatePlayerError(error) {
...
var deletePlayerError = function deletePlayerError(error) {
...
module.exports = {
  signInFillRosterSuccess: signInFillRosterSuccess,
  assignPlayerToRosterSuccess: assignPlayerToRosterSuccess,
  assignPlayerToRosterError: assignPlayerToRosterError,
  showAllPlayersSuccess: showAllPlayersSuccess,
  createPlayerSuccess: createPlayerSuccess,
  createPlayerError: createPlayerError,
  updatePlayerSuccess: updatePlayerSuccess,
  updatePlayerError: updatePlayerError,
  deletePlayerSuccess: deletePlayerSuccess,
  deletePlayerError: deletePlayerError,
...
var indexPlayer = function indexPlayer(id) {
  return $.ajax({
    method: 'GET',
...
var showPlayers = function showPlayers() {
  return $.ajax({
    method: 'GET',
...
var userProfile = __webpack_require__(6);
var playerEvent = __webpack_require__(7);
var playerUi = __webpack_require__(8);
...
var userEvent = __webpack_require__(6);
var playerEvent = __webpack_require__(7);
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signIn(data).then(authUi.signInSuccess).then(userEvent.onGetUser).then(playerEvent.onSignInFillRoster).catch(authUi.signInError);
};
...
var getUserSuccess = function getUserSuccess(response) {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <!-- "
    ...
    + ", Position: "
    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.position : stack1), depth0))
    + ",\n   Keeper:  "
    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.keeper : stack1), depth0))
    + ", Fantasy Owner: "
    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.user_id : stack1), depth0))
    + ",\n  Current Roster Spot: "
    + alias1(alias2(((stack1 = blockParams[0][0]) != null ? stack1.roster_spot : stack1), depth0))
    + "</li>\n<hr>\n\n\n\n";
...
module.exports = __webpack_require__.p + "3f06b5f64d7ed129bca6fcba16917710.png";
